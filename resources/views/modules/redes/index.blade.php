...
<div class="pagetitle d-flex justify-content-between align-items-center flex-wrap gap-2">
    <div>
        <h1 class="mb-0"><i class="bi bi-share me-2"></i>Redes</h1>
    ...
    <a href="{{ route('redes.create') }}" class="btn btn-primary">
            ...
            <table class="table table-hover align-middle mb-0 datatable">
                <thead class="table-light">
                    <tr>
                        ...
                        <th class="text-center">Líderes principales</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">{{ $red->lideres_principales_count }}</td>
                        <td class="text-center">{{ $red->puntos_conexion_count }}</td>
                        <td class="text-center">
                            <a href="{{ route('redes.edit', $red->id) }}" class="btn btn-outline-warning btn-sm" title="Editar">
                                <i class="bi bi-pencil"></i>
                            </a>
                            <form action="{{ route('redes.destroy', $red->id) }}" method="POST" class="d-inline form-delete" data-nombre="{{ $red->nombre }}">
                                @csrf @method('DELETE')
