                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <span class="badge bg-primary rounded-pill">{{ $rol->users_count }}</span>
                        </td>
                        <td class="text-center">
                            <a href="{{ route('roles.edit', $rol->id) }}" class="btn btn-outline-warning btn-sm" title="Editar">
                                <i class="bi bi-pencil"></i>
                            </a>
                            <form action="{{ route('roles.destroy', $rol->id) }}" method="POST" class="d-inline form-delete" data-nombre="{{ $rol->nombre }}">
                                @csrf @method('DELETE')
