...
<div class="pagetitle">
    <h1 class="mb-0"><i class="bi bi-bank me-2"></i>Editar cuenta bancaria</h1>
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb mb-0 small">
            <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Inicio</a></li>
            <li class="breadcrumb-item"><a href="{{ route('cuentas_bancarias.index') }}">Cuentas bancarias</a></li>
...
<div class="card border-0 shadow-sm">
    <div class="card-body">
        <form action="{{ route('cuentas_bancarias.update', $cuenta->id) }}" method="POST">
            @csrf
            @method('PUT')
            @include('modules.cuentas_bancarias.form')
